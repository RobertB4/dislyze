...
// ===== NEW SEED DATA (seed_localhost.sql) =====

export const TestUsersData2 = {
...
export type TestUserKey2 = keyof typeof TestUsersData2;
export type TestUser2 = (typeof TestUsersData2)[TestUserKey2];

export const TestTenantsData2 = {
	enterprise: {
	...
	smb: {
		...
		name: "SMB株式会社",
		enterpriseFeatures: { rbac: { enabled: false } }
	},
	internal: {
...
export type TestTenantKey2 = keyof typeof TestTenantsData2;
export type TestTenant2 = (typeof TestTenantsData2)[TestTenantKey2];

export const TestRolesData2 = {
...
export type TestRoleKey2 = keyof typeof TestRolesData2;
export type TestRole2 = (typeof TestRolesData2)[TestRoleKey2];

export const TestInvitationTokensData2 = {
	enterprise_11_valid: {
...
export type TestInvitationTokenKey2 = keyof typeof TestInvitationTokensData2;
export type TestInvitationToken2 = (typeof TestInvitationTokensData2)[TestInvitationTokenKey2];
