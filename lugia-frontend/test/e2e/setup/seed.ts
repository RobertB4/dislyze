...
export type TestRoleKey = keyof typeof TestRolesData;
export type TestRole = (typeof TestRolesData)[TestRoleKey];

export const TestInvitationTokensData = {
	enterprise_11_valid: {
...
export type TestInvitationTokenKey = keyof typeof TestInvitationTokensData;
export type TestInvitationToken = (typeof TestInvitationTokensData)[TestInvitationTokenKey];
