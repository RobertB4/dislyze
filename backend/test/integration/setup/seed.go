...
var TestUsersData = map[string]struct {
	...
	"alpha_editor": {Email: "alpha_user@example.com", PlainTextPassword: "password123", UserID: "b0000000-0000-0000-0000-000000000002", TenantID: "a0000000-0000-0000-0000-000000000001", Name: "Alpha User", Role: "editor"},
