...
('b0000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000001', 'pending_user_valid_token@example.com', '$2a$10$THcoOx7wWaJXBpVigz/d9etow0c5SZtARYw9V6Abx9Q5.ao8/EbZ', 'Pending User Valid Token', 'editor', 'pending_verification', '2024-01-01 11:02:00+00', '2024-01-01 11:02:00+00'),
('b0000000-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000001', 'suspended_user@example.com', '$2a$10$oadek4URiwb4gMH1/Llscusq97X3jLWTB2skaIYh5.8yy3W9.kGsS', 'Suspended User', 'editor', 'suspended', '2024-01-01 11:03:00+00', '2024-01-01 11:03:00+00'),
('b0000000-0000-0000-0000-000000000005', 'a0000000-0000-0000-0000-000000000001', 'pending_user_for_rate_limit_test@example.com', '$2a$10$THcoOx7wWaJXBpVigz/d9etow0c5SZtARYw9V6Abx9Q5.ao8/EbZ', 'Pending User Rate Limit Test', 'editor', 'pending_verification', '2024-01-01 11:04:00+00', '2024-01-01 11:04:00+00'),
('b0000000-0000-0000-0000-000000000006', 'a0000000-0000-0000-0000-000000000001', 'pending_user_tenant_A_for_x_tenant_test@example.com', '$2a$10$hssV3F7y33jE2etR.IIkUu2t6d33p2uQ0fG1gS.gY0qY8G.x0aLqS', 'PendingXT User', 'editor', 'pending_verification', '2024-01-01 11:05:00+00', '2024-01-01 11:05:00+00');
...
-- Token for pending_user_valid_token@example.com (User ID: b...3)
...
-- Token for pending_user_for_rate_limit_test@example.com (User ID: b...5)
...
-- Token for pending_user_tenant_A_for_x_tenant_test@example.com (User ID: b...6)
