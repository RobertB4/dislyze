...
('d0000000-0000-0000-0000-000000000001', 'users', 'view', 'ユーザー一覧の閲覧', '2024-01-01 09:00:00+00', '2024-01-01 09:00:00+00'),
('d0000000-0000-0000-0000-000000000002', 'users', 'create', 'ユーザーの招待・作成', '2024-01-01 09:01:00+00', '2024-01-01 09:01:00+00'),
('d0000000-0000-0000-0000-000000000003', 'users', 'update', 'ユーザー権限の変更', '2024-01-01 09:02:00+00', '2024-01-01 09:02:00+00'),
('d0000000-0000-0000-0000-000000000004', 'users', 'delete', 'ユーザーの削除', '2024-01-01 09:03:00+00', '2024-01-01 09:03:00+00'),
('d0000000-0000-0000-0000-000000000005', 'tenant', 'update', 'テナント設定の変更', '2024-01-01 09:04:00+00', '2024-01-01 09:04:00+00');

INSERT INTO roles (id, tenant_id, name, description, created_at, updated_at) VALUES
('e0000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', '管理者', 'すべての管理機能にアクセス可能', '2024-01-01 09:30:00+00', '2024-01-01 09:30:00+00'),
('e0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001', '編集者', '限定的な編集権限', '2024-01-01 09:31:00+00', '2024-01-01 09:31:00+00');

INSERT INTO roles (id, tenant_id, name, description, created_at, updated_at) VALUES
('e0000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000002', '管理者', 'すべての管理機能にアクセス可能', '2024-01-01 09:32:00+00', '2024-01-01 09:32:00+00'),
('e0000000-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000002', '編集者', '限定的な編集権限', '2024-01-01 09:33:00+00', '2024-01-01 09:33:00+00');

INSERT INTO role_permissions (role_id, permission_id, created_at) VALUES
-- Admin roles get all permissions
-- Tenant Alpha admin (e...1)
('e0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000001', '2024-01-01 09:40:00+00'), -- users.view
('e0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000002', '2024-01-01 09:40:01+00'), -- users.create
('e0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000003', '2024-01-01 09:40:02+00'), -- users.update
('e0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000004', '2024-01-01 09:40:03+00'), -- users.delete
('e0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000005', '2024-01-01 09:40:04+00'), -- tenant.update

-- Tenant Beta admin (e...3)
('e0000000-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000001', '2024-01-01 09:41:00+00'), -- users.view
('e0000000-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000002', '2024-01-01 09:41:01+00'), -- users.create
('e0000000-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000003', '2024-01-01 09:41:02+00'), -- users.update
('e0000000-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000004', '2024-01-01 09:41:03+00'), -- users.delete
('e0000000-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000005', '2024-01-01 09:41:04+00'), -- tenant.update
...
-- Tenant Alpha users
('b0000000-0000-0000-0000-000000000001', 'e0000000-0000-0000-0000-000000000001', '2024-01-01 11:10:00+00'), -- Alpha Admin -> admin role
('b0000000-0000-0000-0000-000000000002', 'e0000000-0000-0000-0000-000000000002', '2024-01-01 11:11:00+00'), -- Alpha Editor -> editor role
('b0000000-0000-0000-0000-000000000003', 'e0000000-0000-0000-0000-000000000002', '2024-01-01 11:12:00+00'), -- Pending Editor Valid Token -> editor role
('b0000000-0000-0000-0000-000000000004', 'e0000000-0000-0000-0000-000000000002', '2024-01-01 11:13:00+00'), -- Suspended Editor -> editor role
('b0000000-0000-0000-0000-000000000005', 'e0000000-0000-0000-0000-000000000002', '2024-01-01 11:14:00+00'), -- Pending Editor Rate Limit -> editor role
('b0000000-0000-0000-0000-000000000006', 'e0000000-0000-0000-0000-000000000002', '2024-01-01 11:15:00+00'), -- Pending Editor X Tenant -> editor role
-- Tenant Beta users  
('b0000000-0000-0000-0000-000000000007', 'e0000000-0000-0000-0000-000000000003', '2024-01-01 11:16:00+00'); -- Beta Admin -> admin role
